...
var G__27617 = phzr.game_object_factory.sprite.cljs$core$IFn$_invoke$arity$4(factory,initial_x,initial_y,asset_key);
phzr.core.pset_BANG_(G__27617,cljs.core.cst$kw$name,sprite_name);
...
var G__27619 = phzr.group.create.cljs$core$IFn$_invoke$arity$4(group,initial_x,initial_y,asset_key);
phzr.core.pset_BANG_(G__27619,cljs.core.cst$kw$name,sprite_name);
...
var factory = cljs.core.cst$kw$add.cljs$core$IFn$_invoke$arity$1(phzr_game);
var G__27621 = phzr.game_object_factory.tween(factory,sprite);
phzr.tween.to.cljs$core$IFn$_invoke$arity$8(G__27621,tween_map,duration,null,false,(0),tween_repeat,yoyo);
