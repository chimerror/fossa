 ...
 * @implements {cljs.core.ILookup}
*/
fossa.component.MovementResults = (function (previous_results,movement_results_text,__meta,__extmap,__hash){
this.previous_results = previous_results;
this.movement_results_text = movement_results_text;
this.__meta = __meta;
this.__extmap = __extmap;
this.__hash = __hash;
this.cljs$lang$protocol_mask$partition0$ = 2229667594;
...
break;
case "movement-results-text":
return self__.movement_results_text;
...
;
return cljs.core.pr_sequential_writer(writer__20885__auto__,pr_pair__20887__auto__,"#fossa.component.MovementResults{",", ","}",opts__20886__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$previous_DASH_results,self__.previous_results],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$movement_DASH_results_DASH_text,self__.movement_results_text],null))], null),self__.__extmap));
});
...
return (new cljs.core.RecordIter((0),G__27124__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$previous_DASH_results,cljs.core.cst$kw$movement_DASH_results_DASH_text], null),cljs.core._iterator(self__.__extmap)));
});
...
var self__ = this;
var this__20864__auto____$1 = this;
return (new fossa.component.MovementResults(self__.previous_results,self__.movement_results_text,self__.__meta,self__.__extmap,self__.__hash));
});
...
var self__ = this;
var this__20879__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$previous_DASH_results,null,cljs.core.cst$kw$movement_DASH_results_DASH_text,null], null), null),k__20880__auto__)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,this__20879__auto____$1),self__.__meta),k__20880__auto__);
} else {
return (new fossa.component.MovementResults(self__.previous_results,self__.movement_results_text,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__20880__auto__)),null));
}
});
...
return (new fossa.component.MovementResults(G__27124,self__.movement_results_text,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27128.cljs$core$IFn$_invoke$arity$2 ? pred__27128.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$movement_DASH_results_DASH_text,expr__27129) : pred__27128.call(null,cljs.core.cst$kw$movement_DASH_results_DASH_text,expr__27129)))){
return (new fossa.component.MovementResults(self__.previous_results,G__27124,self__.__meta,self__.__extmap,null));
} else {
return (new fossa.component.MovementResults(self__.previous_results,self__.movement_results_text,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__20878__auto__,G__27124),null));
}
}
});
...
var self__ = this;
var this__20882__auto____$1 = this;
return cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$previous_DASH_results,self__.previous_results],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$movement_DASH_results_DASH_text,self__.movement_results_text],null))], null),self__.__extmap));
});

fossa.component.MovementResults.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__20869__auto__,G__27124){
var self__ = this;
var this__20869__auto____$1 = this;
return (new fossa.component.MovementResults(self__.previous_results,self__.movement_results_text,G__27124,self__.__extmap,self__.__hash));
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$previous_DASH_results,cljs.core.cst$sym$movement_DASH_results_DASH_text], null);
});
...
fossa.component.__GT_MovementResults = (function fossa$component$__GT_MovementResults(previous_results,movement_results_text){
return (new fossa.component.MovementResults(previous_results,movement_results_text,null,null,null));
});

fossa.component.map__GT_MovementResults = (function fossa$component$map__GT_MovementResults(G__27126){
return (new fossa.component.MovementResults(cljs.core.cst$kw$previous_DASH_results.cljs$core$IFn$_invoke$arity$1(G__27126),cljs.core.cst$kw$movement_DASH_results_DASH_text.cljs$core$IFn$_invoke$arity$1(G__27126),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27126,cljs.core.cst$kw$previous_DASH_results,cljs.core.array_seq([cljs.core.cst$kw$movement_DASH_results_DASH_text], 0)),null));
});
 ...
 * @implements {cljs.core.ILookup}
*/
fossa.component.DungeonStatus = (function (sprite,text,__meta,__extmap,__hash){
this.sprite = sprite;
this.text = text;
this.__meta = __meta;
this.__extmap = __extmap;
...
fossa.component.DungeonStatus.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__20870__auto__,k__20871__auto__){
var self__ = this;
var this__20870__auto____$1 = this;
return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(this__20870__auto____$1,k__20871__auto__,null);
});

fossa.component.DungeonStatus.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__20872__auto__,k27141,else__20873__auto__){
var self__ = this;
var this__20872__auto____$1 = this;
var G__27143 = (((k27141 instanceof cljs.core.Keyword))?k27141.fqn:null);
switch (G__27143) {
case "sprite":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k27141,else__20873__auto__);

}
});

fossa.component.DungeonStatus.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__20884__auto__,writer__20885__auto__,opts__20886__auto__){
var self__ = this;
var this__20884__auto____$1 = this;
var pr_pair__20887__auto__ = ((function (this__20884__auto____$1){
return (function (keyval__20888__auto__){
...
;
return cljs.core.pr_sequential_writer(writer__20885__auto__,pr_pair__20887__auto__,"#fossa.component.DungeonStatus{",", ","}",opts__20886__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$sprite,self__.sprite],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$text,self__.text],null))], null),self__.__extmap));
});

fossa.component.DungeonStatus.prototype.cljs$core$IIterable$ = true;

fossa.component.DungeonStatus.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27140){
var self__ = this;
var G__27140__$1 = this;
return (new cljs.core.RecordIter((0),G__27140__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$sprite,cljs.core.cst$kw$text], null),cljs.core._iterator(self__.__extmap)));
});

fossa.component.DungeonStatus.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__20868__auto__){
var self__ = this;
var this__20868__auto____$1 = this;
return self__.__meta;
});

fossa.component.DungeonStatus.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__20864__auto__){
var self__ = this;
var this__20864__auto____$1 = this;
return (new fossa.component.DungeonStatus(self__.sprite,self__.text,self__.__meta,self__.__extmap,self__.__hash));
});

fossa.component.DungeonStatus.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__20874__auto__){
var self__ = this;
var this__20874__auto____$1 = this;
return (2 + cljs.core.count(self__.__extmap));
});

fossa.component.DungeonStatus.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__20865__auto__){
var self__ = this;
var this__20865__auto____$1 = this;
var h__20683__auto__ = self__.__hash;
if(!((h__20683__auto__ == null))){
...
fossa.component.DungeonStatus.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__20866__auto__,other__20867__auto__){
var self__ = this;
var this__20866__auto____$1 = this;
if(cljs.core.truth_((function (){var and__20236__auto__ = other__20867__auto__;
if(cljs.core.truth_(and__20236__auto__)){
...
fossa.component.DungeonStatus.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__20879__auto__,k__20880__auto__){
var self__ = this;
var this__20879__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$sprite,null,cljs.core.cst$kw$text,null], null), null),k__20880__auto__)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,this__20879__auto____$1),self__.__meta),k__20880__auto__);
} else {
return (new fossa.component.DungeonStatus(self__.sprite,self__.text,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__20880__auto__)),null));
}
});

fossa.component.DungeonStatus.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__20877__auto__,k__20878__auto__,G__27140){
var self__ = this;
var this__20877__auto____$1 = this;
var pred__27144 = cljs.core.keyword_identical_QMARK_;
var expr__27145 = k__20878__auto__;
if(cljs.core.truth_((pred__27144.cljs$core$IFn$_invoke$arity$2 ? pred__27144.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$sprite,expr__27145) : pred__27144.call(null,cljs.core.cst$kw$sprite,expr__27145)))){
return (new fossa.component.DungeonStatus(G__27140,self__.text,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27144.cljs$core$IFn$_invoke$arity$2 ? pred__27144.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$text,expr__27145) : pred__27144.call(null,cljs.core.cst$kw$text,expr__27145)))){
return (new fossa.component.DungeonStatus(self__.sprite,G__27140,self__.__meta,self__.__extmap,null));
} else {
return (new fossa.component.DungeonStatus(self__.sprite,self__.text,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__20878__auto__,G__27140),null));
}
}
});

fossa.component.DungeonStatus.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__20882__auto__){
var self__ = this;
var this__20882__auto____$1 = this;
return cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$sprite,self__.sprite],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$text,self__.text],null))], null),self__.__extmap));
});

fossa.component.DungeonStatus.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__20869__auto__,G__27140){
var self__ = this;
var this__20869__auto____$1 = this;
return (new fossa.component.DungeonStatus(self__.sprite,self__.text,G__27140,self__.__extmap,self__.__hash));
});

fossa.component.DungeonStatus.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__20875__auto__,entry__20876__auto__){
var self__ = this;
var this__20875__auto____$1 = this;
if(cljs.core.vector_QMARK_(entry__20876__auto__)){
return cljs.core._assoc(this__20875__auto____$1,cljs.core._nth.cljs$core$IFn$_invoke$arity$2(entry__20876__auto__,(0)),cljs.core._nth.cljs$core$IFn$_invoke$arity$2(entry__20876__auto__,(1)));
...
fossa.component.DungeonStatus.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$sprite,cljs.core.cst$sym$text], null);
});

fossa.component.DungeonStatus.cljs$lang$type = true;

fossa.component.DungeonStatus.cljs$lang$ctorPrSeq = (function (this__20904__auto__){
return cljs.core._conj(cljs.core.List.EMPTY,"fossa.component/DungeonStatus");
});

fossa.component.DungeonStatus.cljs$lang$ctorPrWriter = (function (this__20904__auto__,writer__20905__auto__){
return cljs.core._write(writer__20905__auto__,"fossa.component/DungeonStatus");
});

fossa.component.__GT_DungeonStatus = (function fossa$component$__GT_DungeonStatus(sprite,text){
return (new fossa.component.DungeonStatus(sprite,text,null,null,null));
});

fossa.component.map__GT_DungeonStatus = (function fossa$component$map__GT_DungeonStatus(G__27142){
return (new fossa.component.DungeonStatus(cljs.core.cst$kw$sprite.cljs$core$IFn$_invoke$arity$1(G__27142),cljs.core.cst$kw$text.cljs$core$IFn$_invoke$arity$1(G__27142),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27142,cljs.core.cst$kw$sprite,cljs.core.array_seq([cljs.core.cst$kw$text], 0)),null));
});
