...
return fossa.dialogue.preload_assets(fossa.dungeon.preload_assets(fossa.party_member.preload_assets(fossa.exploration_path.preload_assets(fossa.background.preload_assets(cljs.core.cst$kw$load.cljs$core$IFn$_invoke$arity$1(phzr_game))))));
});
fossa.core.create_game_BANG_ = (function fossa$core$create_game_BANG_(_){
var s = fossa.dialogue.create_entities(fossa.dungeon.create_entities(fossa.party_member.create_entities(fossa.exploration_path.create_entities(fossa.group.create_entities(fossa.background.create_entities((function (){var G__30728 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(fossa.core._STAR_system_STAR_) : cljs.core.deref.call(null,fossa.core._STAR_system_STAR_)),cljs.core.cst$kw$events,cljs.core.PersistentArrayMap.EMPTY);
phzr.core.pset_BANG_(cljs.core.cst$kw$input.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$phzr_DASH_game.cljs$core$IFn$_invoke$arity$1(G__30728)),cljs.core.cst$kw$max_DASH_pointers,(1));
...
var events = cljs.core.cst$kw$events.cljs$core$IFn$_invoke$arity$1(system);
...
var s = brute.system.process_one_game_tick(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(system,cljs.core.cst$kw$events,fossa.input.get_events_BANG_(events)),delta);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(fossa.core._STAR_system_STAR_,s) : cljs.core.reset_BANG_.call(null,fossa.core._STAR_system_STAR_,s));
});
...
var temp__4657__auto___30729 = cljs.core.cst$kw$phzr_DASH_game.cljs$core$IFn$_invoke$arity$1((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(fossa.core._STAR_system_STAR_) : cljs.core.deref.call(null,fossa.core._STAR_system_STAR_)));
if(cljs.core.truth_(temp__4657__auto___30729)){
var curr_game_30730 = temp__4657__auto___30729;
phzr.game.destroy(curr_game_30730);
} else {
}

fossa.input.clear_events_BANG_();

var s = brute.system.add_system_fn(brute.system.add_system_fn(brute.system.add_system_fn(brute.system.add_system_fn(brute.system.add_system_fn(brute.system.add_system_fn(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(brute.entity.create_system(),cljs.core.cst$kw$phzr_DASH_game,fossa.core.get_new_phzr_game_object()),fossa.background.process_one_game_tick),fossa.exploration_path.process_one_game_tick),fossa.party_member.process_one_game_tick),fossa.group.process_one_game_tick),fossa.dungeon.process_one_game_tick),fossa.dialogue.process_one_game_tick);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(fossa.core._STAR_system_STAR_,s) : cljs.core.reset_BANG_.call(null,fossa.core._STAR_system_STAR_,s));
});
var G__30731_30732 = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$google,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$families,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Cutive","Just Me Again Down Here"], null)], null),cljs.core.cst$kw$active,fossa.core.initialize_game_BANG_,cljs.core.cst$kw$inactive,fossa.core.initialize_game_BANG_], null));
(WebFont.load.cljs$core$IFn$_invoke$arity$1 ? WebFont.load.cljs$core$IFn$_invoke$arity$1(G__30731_30732) : WebFont.load.call(null,G__30731_30732));
